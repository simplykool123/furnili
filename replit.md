...
- **Recent Activity Feed**: Added right-side panel showing last 5-8 recent updates (new projects, status changes, stock updates) alongside Critical Stock Alerts in a clean two-column grid layout with dynamic icons and timestamps
