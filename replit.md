...
- **UI Text Improvements**: Updated UI text labels for better conciseness: "Inventory Movement" → "Stock Movement", "Product Comparison" → "Compare Products", "Display Settings" → "Theme & Layout", "System Flowchart" → "Workflow" - applied consistently across sidebar navigation, page titles, and headers for cleaner interface
