...
- **Recent Activity Feed**: Implemented and then removed per user request - dashboard now focuses on core KPI cards and task management without stock status/activity sections
