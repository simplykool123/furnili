    ...
    try {
      ...
      if (files) {
        ...
        if (files.receipt && files.receipt[0]) {
          ...
          const receiptFileName = `${paddedId}_01${extension}`;
        ...
        if (files.bill && files.bill[0]) {
          ...
          const paddedId = expense.id.toString().padStart(3, '0');
          const billFileName = `${paddedId}_02${extension}`;
        ...
        if (files.material && files.material[0]) {
          ...
          const paddedId = expense.id.toString().padStart(3, '0');
          const materialFileName = `${paddedId}_03${extension}`;
    ...
    try {
      ...
      if (files) {
        ...
        if (Object.keys(fileUpdateData).length > 0) {
          await storage.updatePettyCashExpense(id, fileUpdateData);
        }
      }
