        ...
        <div style="font-family: Arial, sans-serif; font-size: 12px; margin: 0; padding: 15px;">
          ...
          <table style="width: 100%; border-collapse: collapse; font-size: 11px; margin-top: 0px;">
            ...
            <tr>
              ...
              <td style="border: 2px solid #000; border-left: none; padding: 3px 6px; text-align: right; vertical-align: middle; width: 190px; font-size: 11px;">Total</td>
              <td style="border: 2px solid #000; border-left: none; padding: 3px 6px; text-align: right; vertical-align: middle; width: 90px; font-size: 11px;">
                ₹${(() => {
                  const itemsTotal = items.reduce((sum: number, item: any) => sum + (item.lineTotal || (item.quantity * item.unitPrice) || 0), 0);
            ...
            <tr>
              <td style="border: 2px solid #000; border-top: none; padding: 4px 6px; vertical-align: top; width: calc(100% - 280px);" rowspan="4">
                <h3 style="font-size: 12px; font-weight: bold; margin: 0 0 4px 0;">Furniture Specifications</h3>
                <p style="font-size: 10px; margin: 1px 0; line-height: 1.2;">- All furniture will be manufactured using Said Materials</p>
                <p style="font-size: 10px; margin: 1px 0; line-height: 1.2;">- All hardware considered of standard make.</p>
                <p style="font-size: 10px; margin: 1px 0; line-height: 1.2;">- Standard laminates considered as per selection.</p>
                <p style="font-size: 10px; margin: 1px 0; line-height: 1.2;">- Any modifications or changes in material selection may result in additional charges.</p>
              </td>
              <td style="border: 2px solid #000; border-left: none; border-top: none; padding: 3px 6px; text-align: right; vertical-align: middle; font-size: 11px;">Packaging @ 2%</td>
              <td style="border: 2px solid #000; border-left: none; border-top: none; padding: 3px 6px; text-align: right; vertical-align: middle; font-size: 11px;">
                ₹${(() => {
                  const itemsTotal = items.reduce((sum: number, item: any) => sum + (item.lineTotal || (item.quantity * item.unitPrice) || 0), 0);
                  const packagingAmount = Math.round(itemsTotal * 0.02);
            ...
            <tr>
              <td style="border: 2px solid #000; border-left: none; border-top: none; padding: 3px 6px; text-align: right; vertical-align: middle; font-size: 11px;">Transportation</td>
              <td style="border: 2px solid #000; border-left: none; border-top: none; padding: 3px 6px; text-align: right; vertical-align: middle; font-size: 11px;">₹5,000</td>
            </tr>
            
            <tr>
              <td style="border: 2px solid #000; border-left: none; border-top: none; padding: 3px 6px; text-align: right; vertical-align: middle; font-size: 11px;">GST @ 18%</td>
              <td style="border: 2px solid #000; border-left: none; border-top: none; padding: 3px 6px; text-align: right; vertical-align: middle; font-size: 11px;">
                ₹${(() => {
                  const itemsTotal = items.reduce((sum: number, item: any) => sum + (item.lineTotal || (item.quantity * item.unitPrice) || 0), 0);
                  const gstAmount = Math.round(itemsTotal * 0.18);
            ...
            <tr style="font-weight: bold;">
              <td style="border: 2px solid #000; border-left: none; border-top: none; padding: 3px 6px; text-align: right; vertical-align: middle; background-color: #f0f0f0; font-size: 11px; font-weight: bold;">Grand Total</td>
              <td style="border: 2px solid #000; border-left: none; border-top: none; padding: 3px 6px; text-align: right; vertical-align: middle; background-color: #f0f0f0; font-size: 11px; font-weight: bold;">
                ₹${(() => {
                  const itemsTotal = items.reduce((sum: number, item: any) => sum + (item.lineTotal || (item.quantity * item.unitPrice) || 0), 0);
                  const packagingAmount = Math.round(itemsTotal * 0.02);
                  const transportationAmount = 5000;
          ...
          <div style="margin-top: 0px; display: flex; align-items: stretch;">
            ...
            <div style="border: 2px solid #000; border-top: none; padding: 6px; flex: 1; border-right: none;">
              <h3 style="font-size: 12px; font-weight: bold; margin: 0 0 6px 0;">Payment Terms</h3>
              <p style="font-size: 10px; margin: 1px 0; line-height: 1.2;">30% Advance Payment: Due upon order confirmation.</p>
              <p style="font-size: 10px; margin: 1px 0; line-height: 1.2;">50% Payment Before Delivery: To be settled prior to dispatch.</p>
              <p style="font-size: 10px; margin: 1px 0; line-height: 1.2;">20% Payment on Delivery</p>
            </div>
            
            <!-- Middle: Bank Details -->
            <div style="border: 2px solid #000; border-top: none; padding: 6px; width: 150px; border-right: none;">
              <h3 style="font-size: 12px; font-weight: bold; margin: 0 0 6px 0;">Bank Details</h3>
              <p style="font-size: 10px; margin: 1px 0; line-height: 1.2;">A/C Name: Furnili</p>
              <p style="font-size: 10px; margin: 1px 0; line-height: 1.2;">Bank: ICICI Bank</p>
              <p style="font-size: 10px; margin: 1px 0; line-height: 1.2;">Branch: Nigdi</p>
              <p style="font-size: 10px; margin: 1px 0; line-height: 1.2;">A/C No.: 230505006647</p>
              <p style="font-size: 10px; margin: 1px 0; line-height: 1.2;">IFSC: ICIC0002305</p>
            </div>
            
            <!-- Right: Authorised Signatory -->
            <div style="border: 2px solid #000; border-top: none; padding: 6px; width: 140px; display: flex; flex-direction: column; justify-content: space-between; align-items: center;">
              ...
              <div style="height: 30px; width: 100px; margin: 8px 0; border-bottom: 1px solid #000;"></div>
            </div>
          </div>
