          ...
          <table style="width: 100%; border-collapse: collapse; margin-bottom: 0px; font-size: 11px;">
            <thead>
              <tr style="background-color: #f0f0f0;">
                <th style="border: 2px solid #000; padding: 8px; text-align: center; width: 40px;">Sr. No.</th>
                <th style="border: 2px solid #000; padding: 8px; text-align: center; width: 120px;">Product </th>
                <th style="border: 2px solid #000; padding: 8px; text-align: center;">Item Description</th>
                <th style="border: 2px solid #000; padding: 8px; text-align: center; width: 80px;">Size</th>
                <th style="border: 2px solid #000; padding: 8px; text-align: center; width: 50px;">Qty</th>
                <th style="border: 2px solid #000; padding: 8px; text-align: center; width: 60px;">Rate</th>
                <th style="border: 2px solid #000; padding: 8px; text-align: center; width: 90px;">Total Amount</th>
              </tr>
            </thead>
            <tbody>
              ${items
                .map((itemData: any, index: number) => {
                  ...
                  return `
                <tr>
                  <td style="border: 2px solid #000; padding: 8px; text-align: center; vertical-align: top;">${index + 1}</td>
                  ...
                  <td style="border: 2px solid #000; padding: 8px; vertical-align: top;">${item.description || product.description || ""}</td>
                  <td style="border: 2px solid #000; padding: 8px; text-align: center; vertical-align: top;">${item.size || "-"}</td>
                  <td style="border: 2px solid #000; padding: 8px; text-align: center; vertical-align: top;">${item.quantity || 0}</td>
                  <td style="border: 2px solid #000; padding: 8px; text-align: right; vertical-align: top;">₹${(item.unitPrice || 0).toFixed(0)}</td>
                  <td style="border: 2px solid #000; padding: 8px; text-align: right; vertical-align: top;">₹${((item.quantity || 0) * (item.unitPrice || 0)).toFixed(0)}</td>
                </tr>
              `;
                })
                .join("")}
