      ...
      element.innerHTML = `
        <div style="font-family: Arial, sans-serif; font-size: 12px; margin: 0; padding: 20px;">
          ...
          <table style="width: 100%; border-collapse: collapse; margin-bottom: 0px; font-size: 11px;">
            <thead>
              <tr style="background-color: #f0f0f0;">
                ...
                <th style="border: 1px solid #000; padding: 8px; text-align: center; width: 120px;">Product </th>
                ...
                <th style="border: 1px solid #000; padding: 8px; text-align: center; width: 60px;">Rate</th>
          ...
          <table style="width: 100%; border-collapse: collapse; font-size: 11px; margin-top: 0px;">
            ...
            <tr>
              <td style="border: 1px solid #000; padding: 6px 8px; vertical-align: middle; width: calc(100% - 280px); height: 31px;">
